...
if __name__ == "__main__":
    ...
    learning.train(env, verbose = True, shuffle_cap=100, save_steps = True, file='q_learning/models/Qnet4x4LR') # use shuffle cap next time
    dqn.save_model("q_learning/models/Qnet4x4LR/final")
